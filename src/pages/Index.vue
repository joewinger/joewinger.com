  ...
  <Layout>
    ...
    <div class="content-wrapper">
      ...
      <section id="contact">
        ...
        <p data-aos="fade-up" data-aos-delay="300" data-aos-anchor=".contact-title" v-if="$settings.hireable"><a href="/Resume%20-%20Joe%20Winger.pdf" class="btn">Download&nbsp;Résumé</a></p>
